...
export const featureMedia = {
  ...
  credentialManagement: { hero: IMG.dashboardAnalytics, urlBar: 'app.credsure.io · Credentials',    alt: 'CredSure credential management dashboard showing issued credentials, status, renewals, role-based access and a complete audit trail across the whole credentialing program' },
  digitalCertificates:  { hero: IMG.certificateGrid,    composed: true,                            alt: 'Grid of eight verifiable digital certificate designs — completion, achievement, blockchain-verified — issued via CredSure for Data Analytics, Web Development, PMP, Strategic Leadership, UI/UX, Data Science, Digital Marketing and Financial Management programmes' },
